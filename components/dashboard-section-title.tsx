    ...
    <div className={cn("mb-3 flex items-center gap-2.5 px-0.5 sm:mb-4", tier === "quiet" && "mb-2.5 sm:mb-3", className)}>
      ...
      <h2
        className={cn(
          ...
          tier === "default"
            ? "text-xs uppercase tracking-[0.16em] sm:text-[13px] lg:text-sm lg:tracking-[0.14em] xl:text-[0.9375rem]"
            : "text-[11px] uppercase tracking-[0.14em] text-slate-500 sm:text-xs lg:text-[13px] xl:text-sm"
        )}
      >
        {children}
      </h2>
