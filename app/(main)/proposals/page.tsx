...
type ListPayload = { ok?: boolean; data?: { id: string; customer_name: string; generated_at: string; system_kw: number; final_amount_inr: number | null }[] };
      ...
      <ProposalHubHeader
        ...
        action={
          <Button asChild variant="emeraldCta" size="lg" className="shadow-lg">
            <Link href="/proposal">{t("proposals_createCta")}</Link>
          </Button>
        }
      />
