...
export const ORG_TYPES: Record<OrgType, OrgTypeSpec> = {
  ...
  mall: {
    ...
    labelEn: "Mall / Retail",
    labelHi: "मॉल / रिटेल",
    descriptionEn: "Shopping centres and retail outlets with high footfall loads",
    typicalKwMin: 100,
    typicalKwMax: 2000,
    defaultKw: 300,
    primaryBenefit: "cost_reduction",
  ...
  office: {
    id: "office",
    labelEn: "Office / IT Park",
    labelHi: "ऑफिस / आईटी पार्क",
    descriptionEn: "Corporate offices and IT parks with UPS and HVAC loads",
    typicalKwMin: 20,
    typicalKwMax: 500,
    defaultKw: 100,
    primaryBenefit: "cost_reduction",
  ...
  industry: {
    id: "industry",
    labelEn: "Industry / Process",
    labelHi: "उद्योग / प्रोसेस",
    descriptionEn: "Large-scale industrial process units with high load factors",
    typicalKwMin: 200,
    typicalKwMax: 5000,
    defaultKw: 500,
    primaryBenefit: "cost_reduction",
